const fs = require("fs");
const path = "src/Data/CAP_02_2024.json";
...
function updateDistricts(obj) {
  for (const key in obj) {
    if (typeof obj[key] === "object" && obj[key] !== null) {
      updateDistricts(obj[key]);
    }
  }
  // Check if this object has a 'district' field and its key matches any fix
